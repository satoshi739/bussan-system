...
const FAQS = [
  ...
  },
  {
    ...
    a: "2026年5月末までの期間限定で、通常7日間の無料トライアルを14日間に倍増しています。先着50名様限定の特典で、加えて創業者Satoshiによる直接サポート（Zoom/LINEで1時間）と、機能リクエストの優先対応も付いてきます。期間内にご登録いただいた方は自動的に14日トライアルが適用されます。",
  },
  {
    q: "7日トライアルと14日トライアル、どちらが適用されますか？",
    a: "2026年5月31日 23:59までにご登録いただいた方は、自動的に14日間が適用されます（先着50名様まで）。それ以降は通常の7日間トライアルになります。なお、いずれの場合もトライアル期間内に解約すれば費用は発生しません。",
  },
  {
    q: "🎁 ロンチ特典の「創業者サポート1時間」は何をしてくれますか？",
    a: "Zoom or LINE通話で、創業者Satoshiが直接、あなたの物販フローに合わせた「物販チェッカー」の最適な使い方をレクチャーします。具体的には①現在の仕入れ販路と取扱ジャンルのヒアリング、②それに合わせた機能の使い方デモ、③利益計算の精度を上げる設定、④疑問点・要望のヒアリング、を1時間で行います。日程は登録後にメールで調整します（平日 9:00〜21:00 / 土日も応相談）。",
  },
  {
    q: "Liteプランとはどう違うのですか？",
