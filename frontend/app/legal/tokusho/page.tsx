...
const ROWS = [
  ...
  ["解約・返金", "マイページよりいつでも解約可能。解約後は翌請求期間以降の課金を停止します。課金開始後の返金は、当社が別途認める場合を除き行っておりません。ただし当社に起因する重大な障害が発生した場合はこの限りではございません。"],
  ["無料トライアル", "本サービスは7日間の無料トライアルを提供しています。無料期間中に解約した場合、料金は発生しません。無料期間終了後は、選択されたプランに応じて自動的に課金が開始されます。課金開始後の返金は、当社が別途認める場合を除き行っておりません。"],
  ["サービスの位置づけ", "本サービスは各ECプラットフォーム（Amazon、楽天市場、Yahoo!ショッピング、メルカリ等）の公式サービス・認定サービスではありません。利用結果、アカウント状態、在庫損失等について当社は保証いたしません。"],
