...
export type AppSettingWhereInput = {
  ...
  secret?: Prisma.BoolFilter<"AppSetting"> | boolean
...
export type AppSettingScalarWhereWithAggregatesInput = {
  ...
  secret?: Prisma.BoolWithAggregatesFilter<"AppSetting"> | boolean
...
export type AppSettingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "secret" | "description" | "updatedBy" | "updatedAt", ExtArgs["result"]["appSetting"]>
...
export interface AppSettingFieldRefs {
  ...
  readonly secret: Prisma.FieldRef<"AppSetting", 'Boolean'>
